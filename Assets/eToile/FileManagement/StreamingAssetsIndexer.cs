...
class StreamingAssetsIndexer : AssetPostprocessor
{
    ...
    static void OnPostprocessAllAssets(string[] importedAssets, string[] deletedAssets, string[] movedAssets, string[] movedFromAssetPaths)
    {
        ...
        if (System.IO.Directory.Exists(Application.streamingAssetsPath))
        {
            ...
            FileManagement.SaveFile(FileManagement.NormalizePath(Application.streamingAssetsPath + "/FMSA_Index"), content, false, true);
        }
        else
        {
            FileManagement.CreateDirectory(Application.streamingAssetsPath, true);
        }
    }
